...
`define     OPCODE_Arith_R_M 5'b01_100
...
`define     F3_SRAI_SRLI     3'b101 
`define     F3_XORI          3'b100
`define     F3_ORI           3'b110
`define     F3_ANDI          3'b111

`define     F7_SLLI          7'b0000000
`define     F7_SRAI          7'b0000000 
`define     F7_SRLI          7'b0100000     
...
`define     ALU_UI          5'b001_10
`define     ALU_SRAI        5'b011_00
